...
Si cette configuration t’inspire, tu peux retrouver mon fichier `.ssh/config` complet <a href="https://github.com/r-seize/dotfiles" target="_blank">ici</a> et l’adapter librement à ton propre workflow.